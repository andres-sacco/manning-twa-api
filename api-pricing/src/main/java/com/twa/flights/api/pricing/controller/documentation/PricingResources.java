...
public interface PricingResources {
    ...
    @Operation(description = "Get entity by iso code", responses = {
            ...
            @ApiResponse(responseCode = "500", description = "Internal server error") }, requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(content = @Content(examples = @ExampleObject(name = "Itineraries", summary = "Example of list of itineraries", value = "[{\"id\":\"b131c0a4-0476-4cb2-88bc-54466796ad0e\",\"segments\":[{\"legs\":[{\"origin\":\"BUE\",\"destination\":\"MIA\",\"departureDate\":\"2023-09-29\",\"departureTime\":\"06:00\",\"arrivalDate\":\"2023-09-29\",\"arrivalTime\":\"12:00\",\"number\":2,\"flightDuration\":\"07:00\"}],\"flightDuration\":\"07:00\"},{\"legs\":[{\"origin\":\"MIA\",\"destination\":\"BUE\",\"departureDate\":\"2023-10-03\",\"departureTime\":\"12:00\",\"arrivalDate\":\"2023-10-03\",\"arrivalTime\":\"18:00\",\"number\":5,\"flightDuration\":\"05:00\"}],\"flightDuration\":\"05:00\"}],\"priceInfo\":{\"adults\":{\"tax\":194.92,\"base\":287.49,\"quantity\":1,\"subtotal\":482.41,\"total\":482.41,\"type\":\"ADULT\",\"markup\":null},\"children\":null,\"infants\":null},\"provider\":\"BETA\",\"flightType\":\"ROUND_TRIP\",\"carrier\":\"AF\"}]"))), tags = {
                    "Pricing" })
